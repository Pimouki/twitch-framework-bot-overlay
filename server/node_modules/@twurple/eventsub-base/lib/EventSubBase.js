...
let EventSubBase = class EventSubBase extends typed_event_emitter_1.EventEmitter {
    ...
    onChannelFollow(user, moderatorOrHandler, handler) {
        const userId = this._extractUserIdWithNumericWarning(user, 'subscribeToChannelFollowEvents');
        if (handler) {
            const moderatorId = (0, api_1.extractUserId)(moderatorOrHandler);
            ...
            return this._genericSubscribe(EventSubChannelFollowSubscription_1.EventSubChannelFollowSubscription, moderatorOrHandler, this, userId);
        }
    }
    /**
     ...
     * @param handler  The function that will be called for any new notifications.
     */
    onExtensionBitsTransactionCreate(clientId, handler) {
     ...
     * @param handler The function that will be called for any new notifications.
     */
    onUserAuthorizationGrant(clientId, handler) {
     ...
     * @param handler The function that will be called for any new notifications.
     */
    onUserAuthorizationRevoke(clientId, handler) {
