...
export declare abstract class EventSubBase extends EventEmitter {
    ...
    /** @private */ _legacySecrets: boolean | 'migrate';
    /**
     ...
     * @param handler  The function that will be called for any new notifications.
     */
    onExtensionBitsTransactionCreate(clientId: string, handler: (event: EventSubExtensionBitsTransactionCreateEvent) => void): EventSubSubscription;
    /**
     ...
     * @param handler The function that will be called for any new notifications.
     */
    onUserAuthorizationGrant(clientId: string, handler: (data: EventSubUserAuthorizationGrantEvent) => void): EventSubSubscription;
    /**
     ...
     * @param handler The function that will be called for any new notifications.
     */
    onUserAuthorizationRevoke(clientId: string, handler: (data: EventSubUserAuthorizationRevokeEvent) => void): EventSubSubscription;
    /**
