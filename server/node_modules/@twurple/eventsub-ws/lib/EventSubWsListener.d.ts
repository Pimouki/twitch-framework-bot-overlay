import { UserIdResolvable, type HelixEventSubSubscriptionStatus, type HelixEventSubWebSocketTransportOptions } from '@twurple/api';
import { EventSubBase, EventSubChannelRewardEvent, type EventSubBaseConfig, type EventSubListener, type EventSubSubscription } from '@twurple/eventsub-base';
/**
...
export declare class EventSubWsListener extends EventSubBase implements EventSubListener {
    ...
    override onChannelRewardUpdateForReward: (user: UserIdResolvable, rewardId: string, handler: (data: EventSubChannelRewardEvent) => void) => EventSubSubscription;
    /**
