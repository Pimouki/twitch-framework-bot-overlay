...
export declare class PubSubClient extends EventEmitter {
     ...
     */
    onUserModeration(user: UserIdResolvable, channel: UserIdResolvable, callback: (message: PubSubSubscriptionMessage) => void): PubSubHandler<never>;
    /**
