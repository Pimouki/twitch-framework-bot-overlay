...
/** @private */
export declare type PubSubLowTrustUserMessageData = PubSubLowTrustUserTreatmentMessageData | PubSubLowTrustUserChatMessageData;
/** @private */
export declare type PubSubModActionMessageData = PubSubChatModActionMessageData | PubSubChannelTermsActionMessageData | PubSubChannelRoleChangeMessageData | PubSubUnbanRequestMessageData;
/** @private */
export declare type PubSubMessageData = PubSubAutoModQueueMessageData | PubSubBitsMessageData | PubSubBitsBadgeUnlockMessageData | PubSubLowTrustUserMessageData | PubSubModActionMessageData | PubSubRedemptionMessageData | PubSubSubscriptionMessageData | PubSubUserModerationNotificationMessageData | PubSubWhisperMessageData | unknown;
export declare type PubSubLowTrustUserMessage = PubSubLowTrustUserTreatmentMessage | PubSubLowTrustUserChatMessage;
/** @private */
export declare type PubSubModActionMessage = PubSubChatModActionMessage | PubSubChannelTermsActionMessage | PubSubChannelRoleChangeMessage | PubSubUnbanRequestMessage;
/** @private */
export declare type PubSubMessage = PubSubAutoModQueueMessage | PubSubBitsMessage | PubSubBitsBadgeUnlockMessage | PubSubLowTrustUserMessage | PubSubModActionMessage | PubSubRedemptionMessage | PubSubSubscriptionMessage | PubSubUserModerationNotificationMessage | PubSubWhisperMessage | PubSubCustomMessage;
