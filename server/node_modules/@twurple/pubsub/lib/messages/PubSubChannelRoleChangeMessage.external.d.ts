 ...
 */
export declare type PubSubChannelRoleChangeType = 'moderator_added' | 'moderator_removed' | 'vip_added' | 'vip_removed';
/** @private */
...
//# sourceMappingURL=PubSubChannelRoleChangeMessage.external.d.ts.map