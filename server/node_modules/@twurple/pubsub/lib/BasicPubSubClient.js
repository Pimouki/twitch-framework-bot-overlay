...
const PubSubPacket_external_1 = require("./PubSubPacket.external");
/**
...
let BasicPubSubClient = BasicPubSubClient_1 = class BasicPubSubClient extends typed_event_emitter_1.EventEmitter {
    ...
    async _sendListen(topics, accessToken) {
        await this._sendNonced((0, PubSubPacket_external_1.createListenPacket)(topics, accessToken));
    }
    ...
    async _resolveToken(resolvable) {
        switch (resolvable.type) {
            case 'provider': {
                ...
                const { accessToken } = await (0, auth_1.getValidTokenFromProviderForUser)(provider, userId, scopes, this._logger);
...
exports.BasicPubSubClient = BasicPubSubClient = BasicPubSubClient_1 = tslib_1.__decorate([
    (0, common_1.rtfm)('pubsub', 'BasicPubSubClient')
], BasicPubSubClient);
