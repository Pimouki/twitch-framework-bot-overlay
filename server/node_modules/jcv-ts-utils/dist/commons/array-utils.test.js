...
describe("shuffle test", () => {
    test("should not modify original array", () => {
        ...
        array_utils_1.ArrayUtils.shuffle(original);
        expect(original).toEqual(copy);
    });
    test("should have same elements", () => {
        const origin = [1, 2, 3, 4, 5];
        const shuffle = array_utils_1.ArrayUtils.shuffle(origin);
...
describe("pickRandomOne", () => {
    test("should not modify original array", () => {
        const original = [1, 2, 3, 4, 5];
        const copy = Array.from(original);
        array_utils_1.ArrayUtils.pickRandomOne(original);
        expect(original).toEqual(copy);
    });
    test("throw error when empty array", () => {
        expect(() => array_utils_1.ArrayUtils.pickRandomOne([])).toThrow("array is empty on pickRandom");
    });
    test("return an picked element", () => {
        const array = [1, 2, 3, 4, 5];
        const randomElement = array_utils_1.ArrayUtils.pickRandomOne(array);
...
describe("removeItem", () => {
    test("should not modify original array", () => {
        const original = [1, 2, 3, 4, 5];
        const copy = Array.from(original);
        array_utils_1.ArrayUtils.removeItem(original, 5);
        expect(original).toEqual(copy);
    });
    test("remove item", () => {
        const array = [1, 2, 3, 4, 5];
        ...
        const result = array_utils_1.ArrayUtils.removeItem(array, indexToRemove);
    ...
    test("dont remove element if index is not in range", () => {
        ...
        const result2 = array_utils_1.ArrayUtils.removeItem(array, indexToRemove2);
...
describe("fillWithIndex", () => {
    test("creates an array of the specified size", () => {
        const size = 5;
        const result = array_utils_1.ArrayUtils.fillWithIndex(size);
    ...
    test("fills the array with index values starting from a custom value", () => {
        ...
        const result = array_utils_1.ArrayUtils.fillWithIndex(size, start);
        expect(result).toEqual(expectedResult);
    });
});
describe("updateById", () => {
    test("updates the element at the specified index", () => {
        ...
        const result = array_utils_1.ArrayUtils.updateById(array, indexToUpdate, newValue);
        expect(result).toEqual(expectedResult);
    });
    test("does not modify the original array", () => {
        const array = [1, 2, 3, 4, 5];
        const originalArrayCopy = Array.from(array);
        array_utils_1.ArrayUtils.updateById(array, 1, 99);
    ...
    test("does not update any element when the index is out of bounds", () => {
        ...
        const result2 = array_utils_1.ArrayUtils.updateById(array, indexToUpdate2, newValue);
        expect(result2).toEqual(expectedResult);
    });
});
describe("removeIdentical", () => {
    test("removes duplicate elements from the array", () => {
        ...
        const result = array_utils_1.ArrayUtils.removeDuplicated(array);
        expect(result).toEqual(expectedResult);
    });
    test("does not modify the original array", () => {
        const array = [1, 2, 3, 2, 1, 4, 5, 4];
        const originalArrayCopy = Array.from(array);
        array_utils_1.ArrayUtils.removeDuplicated(array);
        expect(array).toEqual(originalArrayCopy);
    });
...
describe("rangeArray", () => {
    test("should return an reverse array when the length is negative", () => {
        const start = 5;
        const end = 3;
        const result = array_utils_1.ArrayUtils.range(start, end);
...
describe("translateItems", () => {
    test("should return the same array when to is negative", () => {
        ...
        const from = 1;
        const to = -1;
        const result = array_utils_1.ArrayUtils.translateItems(arr, from, to);
...
describe("array operation", () => {
    test("should perform the provided operation on two arrays of equal length", () => {
        ...
        const b = [2, 3, 4, 5];
        const add = (a, b) => a + b;
        const result = array_utils_1.ArrayUtils.operation(a, b, add);
