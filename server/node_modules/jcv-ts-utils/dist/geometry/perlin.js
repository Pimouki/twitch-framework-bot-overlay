...
class Perlin {
    ...
    noise(a, b, c = 0) {
        ...
        return commons_1.NumberUtils.lerp(w, commons_1.NumberUtils.lerp(v, commons_1.NumberUtils.lerp(u, Perlin.grad(P[AA], x, y, z), Perlin.grad(P[BA], x - 1, y, z)), commons_1.NumberUtils.lerp(u, Perlin.grad(P[AB], x, y - 1, z), Perlin.grad(P[BB], x - 1, y - 1, z))), commons_1.NumberUtils.lerp(v, commons_1.NumberUtils.lerp(u, Perlin.grad(P[AA + 1], x, y, z - 1), Perlin.grad(P[BA + 1], x - 1, y, z - 1)), commons_1.NumberUtils.lerp(u, Perlin.grad(P[AB + 1], x, y - 1, z - 1), Perlin.grad(P[BB + 1], x - 1, y - 1, z - 1))));
    }
    setSeed(seed = 3000) {
        this._seedValue = xorshift(seed);
    }
