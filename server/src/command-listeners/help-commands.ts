...
const recentMessages: string[] = []; // Stockage des derniers messages du chat
const recentPhrases: string[] = [];
const memory: string[] = []; // Mémoire pour garder les mots-clés
...
const matchesCommand = (input: string, commandList: string[]): boolean => {
