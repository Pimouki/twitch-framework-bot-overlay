...
exports.SpotifyCommands = void 0;
const SpotifyCommands = async ({ spotify, command, args, chatBotClient: chatClient, channel, }) => {
    /*if (command === "sr") {
...
exports.SpotifyCommands = SpotifyCommands;
